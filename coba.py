...
for i in range(200):
    ...
    p.setJointMotorControl2(boxId, 2 , p.VELOCITY_CONTROL, targetVelocity = -0.5, force= 250_000)
    # p.setJointMotorControl2(boxId, 3 , p.POSITION_CONTROL, targetPosition = 0)
